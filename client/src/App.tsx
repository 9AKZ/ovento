...
export function Layout({ children }: { children: ReactNode }) {
  ...
  const SidebarContent = () => (
    <div className="flex flex-col h-full">
      <div className="p-6">
        {/* ✅ LOGO + TITRE ALIGNÉS CORRECTEMENT */}
        <div className="flex items-center gap-3 mb-8">
          ...
          <h1 className="text-2xl font-bold font-display tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-primary to-green-600">
            Ôvento
          </h1>
        </div>
        ...
        <div className="space-y-1">
          ...
          {user && (
            <>
              <NavLink href="/create" icon={PlusCircle}>
                Créer un Événement
              </NavLink>
    ...
    <div className="min-h-screen bg-background flex">
      ...
      <div className="md:hidden fixed top-0 left-0 right-0 z-50 bg-background/80 backdrop-blur-md border-b border-border/50 px-4 py-3 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          />
          <span className="font-bold font-display text-lg bg-clip-text text-transparent bg-gradient-to-r from-primary to-green-600">
            Ôvento
          </span>
        </div>
